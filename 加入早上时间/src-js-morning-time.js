    ...
    jQuery.ajax({
                ...
                success: function(data) {
                    if (data.timeSlots != null) {
                        ...
                        if( timeslotid_g == null && last_timeslot != null ){
                            timeSlotStartTime_g = last_timeslot.startTime;
                            timeslotid_g = last_timeslot.timeslotID;
                            pickUpSlot_g = last_timeslot.formattedTimeForDisplay;
                        
                            console.log( "              确定取机时间(没有找到指定的取机时间，当前选定为最晚时间). " + pickUpSlot_g + ": " + timeslotid_g + ', ' + timeSlotStartTime_g + ', available:' + val.reservationAvailable );
                        }
